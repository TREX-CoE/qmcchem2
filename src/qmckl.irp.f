...
!  call check_qmckl(rc, irp_here, qmckl_ctx)
!    rc =  qmckl_set_jastrow_champ_cord_num          (qmckl_ctx, 5_8)
!  call check_qmckl(rc, irp_here, qmckl_ctx)
!    rc =  qmckl_set_jastrow_champ_a_vector          (qmckl_ctx, &
!           (/ 0.00000000d0,  0.00000000d0, -0.42116744d0, -0.23116002d0, -0.04147653d0,  0.08442667d0, &
!              0.00000000d0,  0.00000000d0, -0.09315680d0, -0.00876255d0,  0.00412646d0,  0.00697358d0 /), 12_8)
!  call check_qmckl(rc, irp_here, qmckl_ctx)
!    rc =  qmckl_set_jastrow_champ_b_vector          (qmckl_ctx, &
!           (/  0.50000000d0,  0.36828937d0,  0.06971832d0,  0.00738184d0, -0.00312681d0, -0.00251738d0 /), 6_8 )
!  call check_qmckl(rc, irp_here, qmckl_ctx)
!    rc =  qmckl_set_jastrow_champ_c_vector          (qmckl_ctx, &
