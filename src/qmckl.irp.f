...
&BEGIN_PROVIDER [ integer*8, qmckl_mo_num ]
  ...
  if (ifirst == 0) then
   ...
   double precision :: b_vector(6) = dble(&
            (/  0.50000000,  0.65603311,  0.14581988,  0.03138163,  0.00153156, -0.00447302 /) )
...
!   call check_qmckl(rc, irp_here, qmckl_ctx)
!
!   rc =  qmckl_set_jastrow_champ_bord_num          (qmckl_ctx, 0_8)
!   call check_qmckl(rc, irp_here, qmckl_ctx)
!
...
!
!   double precision :: a_vector(12) = dble(&
!            (/    0.00000000,  0.00000000, -0.52998944, -0.13333549, -0.01926541, -0.02051931, &
!                  0.00000000,  0.00000000, -0.13151764,  0.03531692,  0.01850704, -0.01254889 /) )
!
!   double precision :: b_vector(2) = dble(&
!            (/  0.50000000,  0. /) )
!
!   double precision :: c_vector(46)
!      c_vector = 0.d0
