...
match msg with 
 ...
 | "get_properties_ci_dress_h" -> Ezfio.read_string "properties" "ci_dress_h"
 | "get_properties_ci_dress_htilde" -> Ezfio.read_string "properties" "ci_dress_htilde"
 ...
 | "get_properties_ci_dress_opt" -> Ezfio.read_string "properties" "ci_dress_opt"
 ...
 | "has_properties_ci_dress_h" -> if (Ezfio.has_properties_ci_dress_h ()) then "T" else "F"
 | "has_properties_ci_dress_htilde" -> if (Ezfio.has_properties_ci_dress_htilde ()) then "T" else "F"
 ...
 | "has_properties_ci_dress_opt" -> if (Ezfio.has_properties_ci_dress_opt ()) then "T" else "F"
...
let all_ezfio_messages = [ 
   ...
   "properties_ci_dress_opt" ; 
   "properties_ci_dress_mu_opt" ; 
   "properties_ci_dress_mu" ; 
   "properties_ci_dress_htilde" ; 
   "properties_ci_dress_h" ; 
   "properties_ci_dress" ; 
   "ezfio_last_library" ; 
   "ezfio_library" ; 
   "ezfio_user" ; 
